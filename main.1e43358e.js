...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"node_modules/cross-fetch/dist/browser-polyfill.js":[function(require,module,exports) {
(function(self) {
...
},{}],"node_modules/prismic-javascript/dist/prismic-javascript.min.js":[function(require,module,exports) {
var define;
...
},{"cross-fetch/polyfill":"node_modules/cross-fetch/dist/browser-polyfill.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
function sliderOpacity() {
  ...
  window.addEventListener('scroll', function () {
    var scrollPercent = Math.floor(scrollY / targetHeight * 100);
...
var prismicContent = function prismicContent() {
  ...
  var apiEndpoint = "https://regular.cdn.prismic.io/api/v2";
...
prismicContent();
var aboutHover = [document.querySelector('.c-about-data-1'), document.querySelector('.c-about-data-2'), document.querySelector('.c-about-data-3')];
var aboutData = [document.querySelector('.c-data-n1'), document.querySelector('.c-data-n2'), document.querySelector('.c-data-n3')];
console.log(aboutHover);
aboutHover.forEach(function (item, nb) {
  this.addEventListener('mouseenter', function () {
    aboutData[nb].classList.add('active');
    setTimeout(function () {
      aboutData[nb].classList.remove('active');
    }, 5000);
  });
...
//   }]
// })
},{"gsap":"node_modules/gsap/index.js","prismic-javascript":"node_modules/prismic-javascript/dist/prismic-javascript.min.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
